...
import 'package:flutter_app/funcs.dart';
              ...
              ElevatedButton(
                  onPressed: () async {
                    try {
                      ...
                      debugPrint("bin_dir: $binDir");
                      String ffmpegBin = "ffmpeg";
                      if (Platform.isWindows) {
                        ffmpegBin += ".exe";
                      }
                      final ffmpegPth = join(binDir, "ffmpeg", ffmpegBin);
                      final pr = await Process.run(ffmpegPth, ["-version"]);
                      debugPrint("\nStdout: ${pr.stdout}");
                      debugPrint("\nStderr: ${pr.stderr}");
                      setState(() {
                        cmdRes += "\nOut\n${pr.stdout}";
