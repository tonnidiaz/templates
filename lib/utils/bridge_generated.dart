...
class RustImpl implements Rust {
  ...
  Future<String> getName({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_get_name(port_),
      parseSuccessData: _wire2api_String,
      constMeta: kGetNameConstMeta,
      argValues: [],
      hint: hint,
    ));
  }

  FlutterRustBridgeTaskConstMeta get kGetNameConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "get_name",
        argNames: [],
      );
...
class RustWire implements FlutterRustBridgeWireBase {
  ...
  void wire_get_name(
    ...
    return _wire_get_name(
      port_,
    );
  }

  late final _wire_get_namePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_get_name');
  late final _wire_get_name =
      _wire_get_namePtr.asFunction<void Function(int)>();
